...
# CONFIG
# ─────────────────────────────────────────────────────────────
RAW_CSV      = "data/Nifty50_CrossAsset_Merged.csv"
RESULTS_DIR  = "data/backtest_results"
MODELS_DIR   = "models/walk_forward_v4"
OUT_JSON     = "models/walk_forward_v4/walk_forward_results.json"
...
XGB_PARAMS = {
    ...
    "min_child_weight": 5,
    "reg_alpha":        1.0,    # L1 regularisation — prunes noisy features
